  ...
  return (
   ...
   <nav
      ...
      >
        <NavLink
          style={({ isActive }) => ({
            ...
            transition: 'color 0.3s ease', // Добавить плавный переход
          })}
          to='/'
        >
          Рецепты
    ...
    {/* <div>asdasd</div> */}
        ...
        {user ? (
          <>
          <p style={{ marginTop: '10px', fontSize: '30px', color: 'white' }}>{`Welcome! ${user.login}`}</p>
        <button style={{fontSize: '18px', color: 'black',  backgroundColor:'white' }} type='button' onClick={onHandleLOgout}>
          logout
        </button>
        </>
      ) : (
